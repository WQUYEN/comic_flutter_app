import 'package:comic_app_with_getx/views/comic_ongoing/ongoing_comic_controller.dart';
import 'package:comic_app_with_getx/views/home/home_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class OngoingComicPage extends StatefulWidget {
  const OngoingComicPage({super.key});

  @override
  State<OngoingComicPage> createState() => _OngoingComicPageState();
}

class _OngoingComicPageState extends State<OngoingComicPage> {
  final OngoingComicController controller = Get.put(OngoingComicController());
