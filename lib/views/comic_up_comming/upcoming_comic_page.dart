import 'package:comic_app_with_getx/views/comic_up_comming/upcoming_comic_controller.dart';
import 'package:comic_app_with_getx/views/home/home_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class UpcomingComicPage extends StatefulWidget {
  const UpcomingComicPage({super.key});

  @override
  State<UpcomingComicPage> createState() => _UpcomingComicPageState();
}

class _UpcomingComicPageState extends State<UpcomingComicPage> {
  final UpcomingComicController controller = Get.put(UpcomingComicController());
