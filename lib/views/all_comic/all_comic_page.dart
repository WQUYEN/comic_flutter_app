import 'package:comic_app_with_getx/views/all_comic/all_comic_controller.dart';
import 'package:comic_app_with_getx/views/home/home_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AllComicPage extends StatefulWidget {
  const AllComicPage({super.key});

  @override
  State<AllComicPage> createState() => _AllComicPageState();
}

class _AllComicPageState extends State<AllComicPage> {
  final AllComicController controller = Get.put(AllComicController());
